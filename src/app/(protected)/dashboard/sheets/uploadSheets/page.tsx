        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              اختر ملف إكسل أو اسحبه هنا للرفع
            </p>
          </div>
          ...
          <div
            className={`relative border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 ${
              dragActive
                ...
                : "border-gray-300 hover:border-blue-300 hover:bg-gray-50 dark:border-gray-700 dark:hover:border-blue-500 dark:hover:bg-gray-800"
            }`}
          ...
          <div className="mt-8 bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
            ...
            <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
              <li className="flex items-start ">
                <span className="w-2 h-2 bg-blue-500 dark:bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0 ml-2 "></span>
